...
namespace PaymentGateway.UnitTests.Core.Domains
{
    public class PaymentTests
    {
        ...
        public void Constructor_ShouldThrowArgumentNullException_WhenCardNumberIsNullOrEmpty(
        ...
        public void Constructor_ShouldThrowArgumentException_WhenCardNumberLengthInvalid(
            string cardNumber, int expiryMonth, int expiryYear, string cvv, string currency, long amount)
        {
            // Act & Assert
        ...
        public void Constructor_ShouldThrowArgumentException_WhenCardNumberNotNumeric(
            string cardNumber, int expiryMonth, int expiryYear, string cvv, string currency, long amount)
        {
            // Act & Assert
            Assert.Throws<ArgumentException>(() =>
        ...
        [InlineData(0)]
        [InlineData(13)]
        public void Constructor_ShouldThrowArgumentOutOfRangeException_WhenExpiryMonthInvalid(int expiryMonth)
        {
            // Arrange
            string cardNumber = "4111111111111111";
            int expiryYear = 2025;
        ...
        [InlineData(0)]
        [InlineData(10000)]
        public void Constructor_ShouldThrowArgumentOutOfRangeException_WhenExpiryYearInvalid(int expiryYear)
        {
            // Arrange
            string cardNumber = "4111111111111111";
            int expiryMonth = 12;
        ...
        [InlineData("12")]
        [InlineData("12345")]
        public void Constructor_ShouldThrowArgumentOutOfRangeException_WhenCvvInvalid(string cvv)
        {
            // Arrange
            string cardNumber = "4111111111111111";
            int expiryMonth = 12;
